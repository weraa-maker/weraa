  ...
  return (
    <section className="flex flex-col py-20 items-center justify-center bg-gray-900">
      <div className="text-center flex flex-col items-center pb-20">
        ...
        <a href="/contact" className="text-xl bg-white p-4 rounded-lg w-40 flex items-center justify-center text-gray-900 font-semibold hover:bg-gray-100 transition-colors duration-300">
          Contact Sales
        </a>
      </div>
